...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-xl-5">
                    <div class="image-container">
                        <img class="img-fluid" src="${pageContext.request.contextPath}images/details-1.png" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
    ...
    <div class="basic-3">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-5">
                    <div class="image-container">
                        <img class="img-fluid" src="${pageContext.request.contextPath}images/details-2.png" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="img-fluid" src="${pageContext.request.contextPath}images/project-1.jpg" alt="alternative">
                        <div class="card-body">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="img-fluid" src="${pageContext.request.contextPath}images/project-2.jpg" alt="alternative">
                        <div class="card-body">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="img-fluid" src="${pageContext.request.contextPath}images/project-3.jpg" alt="alternative">
                        <div class="card-body">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="img-fluid" src="${pageContext.request.contextPath}images/project-4.jpg" alt="alternative">
                        <div class="card-body">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="img-fluid" src="${pageContext.request.contextPath}images/project-5.jpg" alt="alternative">
                        <div class="card-body">
                    ...
                    <!-- Card -->
                    <div class="card">
                        <img class="img-fluid" src="${pageContext.request.contextPath}images/project-6.jpg" alt="alternative">
                        <div class="card-body">
    ...
    <div class="slider-1 bg-gray">
        <img class="quotes-decoration" src="${pageContext.request.contextPath}images/quotes.svg" alt="alternative">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="swiper-container card-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img class="testimonial-image" src="${pageContext.request.contextPath}images/testimonial-1.jpg" alt="alternative">
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <img class="testimonial-image" src="${pageContext.request.contextPath}images/testimonial-2.jpg" alt="alternative">
                                    <p class="testimonial-text">“Expense bed any sister depend changer off piqued one. Contented continued any happiness instantly objection yet her allowance. Use correct day new brought tedious. By come this been in. Kept easy or sons my it how about some words here done”</p>
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <img class="testimonial-image" src="${pageContext.request.contextPath}images/testimonial-3.jpg" alt="alternative">
                                    <p class="testimonial-text">“Expense bed any sister depend changer off piqued one. Contented continued any happiness instantly objection yet her allowance. Use correct day new brought tedious. By come this been in. Kept easy or sons my it how about some words here done”</p>
    ...
    <div id="contact" class="form-1">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-container">
                        <img class="img-fluid" src="${pageContext.request.contextPath}images/contact.png" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <div class="text-container">
